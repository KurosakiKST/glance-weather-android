...
public final class DayForecast {
    ...
    @org.jetbrains.annotations.NotNull
    public final com.ryan.weather.forecast.domain.model.Condition component19() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull
    public final com.ryan.weather.forecast.domain.model.DayForecast copy(double maxTempC, double maxTempF, double minTempC, double minTempF, double avgTempC, double avgTempF, double maxWindMph, double maxWindKph, double totalPrecipMm, double totalPrecipIn, double totalSnowCm, double avgVisKm, double avgVisMiles, int avgHumidity, int dailyWillItRain, int dailyChanceOfRain, int dailyWillItSnow, int dailyChanceOfSnow, @org.jetbrains.annotations.NotNull
    com.ryan.weather.forecast.domain.model.Condition condition, double uv) {
        return null;
    }
