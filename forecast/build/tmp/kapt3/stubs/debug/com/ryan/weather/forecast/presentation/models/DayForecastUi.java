...
public final class DayForecastUi {
    ...
    @org.jetbrains.annotations.NotNull
    public final com.ryan.weather.forecast.presentation.models.ConditionUi component19() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull
    public final com.ryan.weather.forecast.presentation.models.DayForecastUi copy(double maxTempC, double maxTempF, double minTempC, double minTempF, double avgTempC, double avgTempF, double maxWindMph, double maxWindKph, double totalPrecipMm, double totalPrecipIn, double totalSnowCm, double avgVisKm, double avgVisMiles, int avgHumidity, int dailyWillItRain, int dailyChanceOfRain, int dailyWillItSnow, int dailyChanceOfSnow, @org.jetbrains.annotations.NotNull
    com.ryan.weather.forecast.presentation.models.ConditionUi condition, double uv) {
        return null;
    }
